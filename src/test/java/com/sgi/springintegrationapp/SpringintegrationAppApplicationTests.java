...
import com.sgi.springintegrationapp.si.CountDownLatchHandler;
...
@SpringBootTest
public class SpringintegrationAppApplicationTests {

	private static final Logger LOGGER =
			LoggerFactory.getLogger(SpringintegrationAppApplicationTests.class);
